...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabrasSeparadasPorUnEspacio = palabras.join (" ");
   return(palabrasSeparadasPorUnEspacio);
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   mayoresA18 = array.filter(n => n > 18);
   contador = mayoresA18.length;
   return(contador);
}
